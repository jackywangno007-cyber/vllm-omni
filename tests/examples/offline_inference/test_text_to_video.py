...
from tests.conftest import assert_video_valid
...
def _skip_readme_snippet(language: str, code: str, h2_title: str) -> tuple[bool, str]:
    if language == "python":
        return True, "Python API snippets are intentionally excluded until ExampleRunner collects video assets from python fences"
